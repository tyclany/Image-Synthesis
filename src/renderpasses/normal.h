...
struct NormalPass : RenderPass {
    ...
    void render() override {
        ...
        for (auto& object : objects) {
             ...
             */
            glBindVertexArray(object.vao); // bind vertex array
            glDrawArrays(GL_TRIANGLES, 0, object.nVerts); // draw its triangles
            glBindVertexArray({0}); // bind the vertex array to 0
